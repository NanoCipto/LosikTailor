    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IDtambahan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LSKTAILOR.tambahan')),
            ],
        ),
        migrations.CreateModel(
            name='detailpesanan',
            fields=[
                ...
                ('IDbaju', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LSKTAILOR.baju')),
                ('IDpemesanan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='LSKTAILOR.pemesanan')),
            ],
        ),
    ]
